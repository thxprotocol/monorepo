<template>
    ...
    <b-modal title="Please, confirm your new login method" centered v-model="isShown">
        ...
        ?
        <template #footer>
            <b-button class="w-100" @click="onClickSubmit" :disabled="!isValidAccountVariant" variant="primary">
                <b-spinner v-if="isLoading" small />
                <template v-else> Confirm </template>
            </b-button>
            <b-button class="w-100" @click="onClickCancel" variant="link">Cancel</b-button>
        </template>
    </b-modal>
</template>
