...
const styles = {
    ...
    '.modal': {
        '--bs-modal-bg': theme.elements.cardBg,
        '--bs-modal-color': theme.elements.text,
        '--bs-modal-border-color': theme.elements.navbarBgDarker,
    },
    ...
    '.btn-primary': {
        ...
        '--bs-btn-hover-border-color': theme.elements.btnBgDarker,
        '--bs-btn-focus-bg': theme.elements.btnBgDark,
        '--bs-btn-focus-color': theme.elements.btnText,
        '--bs-btn-focus-border-color': theme.elements.btnBgDarker,
    ...
    '.navbar': {
        ...
        '--txh-navbar-bottom-border-color': theme.elements.navbarBgDarker,
    },
    '.nav-tabs': {
